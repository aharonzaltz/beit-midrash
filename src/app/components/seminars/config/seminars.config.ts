...
export enum HaravInbal {
    ...
    torahFundamentalsShemot = "torah-fundamentals/lessons/shemot",
    ...
    others = "others",
    medina = "medina",
    beerHagola = "beer-hagola",
    kuzari = "kuzari",
    eighteenthPrayer = "eighteenth-prayer",
    nextWorld = "next-world",
    lessonsToAvrechim = "lessons-to-avrechim",
    whatGodRequireOfYou = "what-god-require-of-you",
    scholarshipAndRealism = "scholarship-and-realism",
    yadBinyamin = "yad-binyamin",
    orachChaim = "orach-chaim",
    westernCulture = "western-culture",
    firstAndEnd = "first-and-end",
    mitzotRules = "mitzot-rules",
    mitzotCount = "mitzot-count",
    lifeSuccess = "lifeSuccess",
}
